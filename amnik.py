...
class Amnik:
    # Класс для управления амнамом.
    def __init__(self, am_game):
        # Инициализирует амняма и задает его начальную позицию."""
        ...
        self.image = pygame.image.load('images/amni.bmp')
    ...
    def update(self):
        ...
        if self.moving_right and self.rect.right < self.screen_rect.right:
            self.x += self.settings.amnik_speed
